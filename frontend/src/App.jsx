...
function App() {
  ...
  // Função para resetar tudo e voltar ao formulário
  const handleResetForm = () => {
    ...
    setFeedbackMessage('');
    setIsError(false);
    setShowSuccessPage(false); // Volta para a tela do formulário
  };
